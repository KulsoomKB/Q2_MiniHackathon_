        ...
        <div className="flex flex-col min-h-screen bg-sky-60">
          ...
          <main className="flex-grow container mx-auto p-6">
            ...
            <div className="flex justify-center mb-4">
              <Image
                src="/corolla.jpeg" // Ensure this path matches the image in your `public` folder
            ...
            <p className="text-gray-700 text-base text-center mb-4">
              The 2024 Toyota Corolla offers a perfect blend of style, efficiency, and cutting-edge technology. 
              Known for its reliability and fuel economy, the Corolla remains a top choice for those looking 
