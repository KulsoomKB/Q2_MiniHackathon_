        ...
        <div className="flex flex-col min-h-screen bg-sky-60">
          ...
          <main className="flex-grow container mx-auto p-6">
            ...
            <h1 className="text-2xl font-bold text-center text-gray-800 mb-4">
              Alto 2024 Price in Pakistan, Images, Reviews & Specs
            </h1>
    
            {/* Image */}
            <div className="flex justify-center mb-4">
              <Image
                src="/Alto.png" // Ensure this path matches the image in your `public` folder
                alt="Alto 2024"
            ...
            <p className="text-gray-700 text-base text-center mb-4">
              The 2024 Alto offers a perfect blend of style, efficiency, and cutting-edge technology. 
              Known for its reliability and fuel economy, the Alto remains a top choice for those looking 
